...
import com.huzhou.gjj.bean.Dkjc4;
...
@ContentView(R.layout.activity_hkfs)
public class HkjhActivity extends BaseAppCompatActivity {
    ...
    private void initView() {
        Dkjc3 dkjc = (Dkjc3) getIntent().getSerializableExtra("data");
        ...
        expandList.setAdapter(new HkfsAdapter(this, dkjc.getHkjhxx()));
    }

    class HkfsAdapter extends BaseExpandableListAdapter {
        private Context mContext;
        private List<Dkjc4> list;

        HkfsAdapter(Context context, List<Dkjc4> list) {
        ...
        public View getChildView(int groupPosition, int childPosition,
            ...
            childHolder.account_incurred.setText("应还本金: " + list.get(groupPosition).getGhbj());
            childHolder.account_year.setText("应还利息: "
                    + list.get(groupPosition).getGhlx());
            childHolder.account_code.setText("本息合计: "
                    + list.get(groupPosition).getGhbx());
            childHolder.account_sign.setText("累计利息: "
                    + list.get(groupPosition).getLjlx());
            childHolder.account_number.setText("本金余额: "
                    + list.get(groupPosition).getQmye());
        ...
        public View getGroupView(int groupPosition, boolean isExpanded,
            ...
            groupHolder.account_type.setText(" " + list.get(groupPosition).getQici() + "期"
                    + "(还款年月：" + list.get(groupPosition).getYhrq() + ")");
            return convertView;
        }
