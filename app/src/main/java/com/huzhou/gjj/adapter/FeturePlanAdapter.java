...
public class FeturePlanAdapter extends BaseExpandableListAdapter {
    private Context mContext;
    private List<FeturePlan> list;

    public FeturePlanAdapter(Context context, List<FeturePlan> list) {
