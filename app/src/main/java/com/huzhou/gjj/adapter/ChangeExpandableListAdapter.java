...
public class ChangeExpandableListAdapter extends BaseExpandableListAdapter {

    private Context mContext;
    private List<Change> list;

    public ChangeExpandableListAdapter(Context context, List<Change> list) {
    ...
    public View getChildView(int groupPosition, int childPosition,
        ...
        childHolder.account_number.setText(("交易流水号:  "
                + list.get(groupPosition).getJylsh()));
        childHolder.account_sign.setText("变更值:  "
                + list.get(groupPosition).getBgzd());
        childHolder.account_code.setText(("变更前值:  "
                + list.get(groupPosition).getBgqz())
        );
        childHolder.account_year.setText("变更后值:  "
                + list.get(groupPosition).getBghz());
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        groupHolder.account_type.setText(
                "   交易时间：      " + list.get(groupPosition).getZjczsj());
//        groupHolder.account_date.setText(list.get(groupPosition).getDate());
